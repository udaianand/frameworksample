package com.freecrmold.qa.base;
	...
	public TestBase() {
		...
		try {
			...
			ip = new FileInputStream(
					"D:\\Aanand\\Project\\Selenium_Workspace_Tutorial\\DesignPOMDataDriven1\\src\\main\\java\\com\\freecrmold\\qa\\config\\config.properties");
